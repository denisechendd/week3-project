...
function App() {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${url}/admin/signin`, formData);
  ...
  useEffect(() => {
    ...
    const checkLogin = async () => {
      try {
        await axios.post(`${path}/api/user/check`);
        alert("登入成功");
        setIsAuth(true);
        getProducts();
      } catch (error) {
  ...
  const updateProduct = async (id) => {
    let url = `${path}/api/${url}/admin/product`;
    let method = "post";
